...
import ProjectCover from '@/public/images/covers/cover--klearly.png'
import ProjectLogo from '@/public/logos/logo--klearly--color.svg'
  ...
  return (
    <>
      <main>
        ...
        */}
          <Band div>
            <Image src="/images/projects/klearly/klearly--home.png" alt="" width={1920} height={1080} />
          </Band>
          {/*
      ...
      <Detour meta="Next Case Study" title="ColorShark" link="/projects/colorshark" />
    </>
  )
}