...
export const metadata = {
  title: 'Creative &amp; Experience Design - Skills - Mark Riggan',
  description: '',
}
        ...
        <article>
          ...
          <Band className="band--numbered">
            ...
            <div className="band__content">
              ...
              <Image src="/images/pictures/picture-creative.jpg" alt="" width={1920} height={1080} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
            </div>
          </Band>
          <Band className="band--numbered">
            <div className="band__title-block">
          ...
          <Band className="band--service-callout">
            <div className="band__callout-icon"><IconSolutionC /></div>
