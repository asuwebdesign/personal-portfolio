    ...
    <article className="work__project">
      <Link href={props.project.href}>
        <a className="work__project-link">
          <div className={`work__project-poster ${props.project.className}`}>
            <Image
            ...
            <span className="work__project-poster-symbol" position="bottom-right">{renderSymbol(props.project.symbol.bottomRight)}</span>
          </div>
